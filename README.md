...
The inspiration for this project came from twin.macro. Unlike their approach, this package allows you to use the latest version of tailwindcss with the latest <u>version</u> of @emotion/styled **<u>without any waiting time</u>**. In fact, you need to install (whatever versions of) those packages independently in addition to styledwindcss.
